...
const pb_field_t at_ac_tuwien_iot1718_N2C_fields[5] = {
    ...
    PB_FIELD(  3, UENUM   , REQUIRED, STATIC  , OTHER, at_ac_tuwien_iot1718_N2C, type, roomNo, 0),
    PB_FIELD(  4, FIXED32 , REQUIRED, STATIC  , OTHER, at_ac_tuwien_iot1718_N2C, data, type, 0),
    PB_LAST_FIELD
};
